...
function arr1() {
    ...
    */
    ...
    //York undefined när vi försöker nå det fjärde elementet
...
function arr3() {
    ...
    */
    ...
    cities.push("Krakow");
    cities.push("Berlin");
    console.log(` Det finns ${cities.length} städer i listan`);
...
function arr4() {
    ...
    */
    ...
    console.log(`Listan har ${cities.length} städer i sig`);
    console.log(`Den poppade staden är ${lastCity}`);
    console.log(`Den sista staden i listan är numera ${cities[cities.length - 1]}`);
