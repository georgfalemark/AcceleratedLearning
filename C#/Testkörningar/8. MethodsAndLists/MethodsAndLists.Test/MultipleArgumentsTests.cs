...
namespace MethodsAndLists.Test
{
    ...
    public class MultipleArgumentsTests
    {
        ...
        public void MultiplyAllBy()
        {
            ...
            CollectionAssert.AreEqual(expected, x.MultiplyAllBy_Linq(100, new List<double> { 12, 3.14, 50, 99 }));
        ...
        public void SomeToUpper()
        {
            ...
            List<string> result = x.SomeToUpper(new List<string> { "what", "does", "the", "fox", "says" },
